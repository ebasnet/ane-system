...
export default function StudentLogin() {
    ...
    const handleLogin = (e) => {
        ...
        e.preventDefault();
        axios.post(states.hostname + "/api/handleuser/login", { email, password, type: 'admin' })
            .then(res => {
        ...
        <>
            ...
            <div className="bigContainer text-light container col-md-3 p-4 appearfromTop" style={{marginTop: '100px'}}>
                <form onSubmit={handleLogin}>
                    ...
                    <hr />
                    <Link to="/login" className="link-light link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-50-hover mx-3">
                        Student Login </Link>
                    OR
